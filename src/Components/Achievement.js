        ...
        <div className="item3s">
            ...
            <div class="item31s">
                <div className="item311s">
                    <a href="https://sumitportfolio.onrender.com"><img src="../Media/Portfolio.jpg" alt="" /></a>
                </div>
                <div className="item311s">
                    <h2>Portfolio</h2>
                    <p>
                    ...
                    <a href="https://sumitportfolio.onrender.com"><button>Visit</button></a>
                </div>
            </div>
            <div className="item31s">
                <div className="item311s">
                    <a href="https://rec-pedia.herokuapp.com/"><img src="../Media/REC Pedia.jpg" alt="" /></a>
                </div>
                <div className="item311s">
                    <h2>REC Pedia</h2>
                    <p>
                    ...
                    <a href="https://rec-pedia.herokuapp.com/"><button>Visit</button></a>
                </div>
            </div>
        </div>
    )
